...
const TopBar = ({ onMenuClick }) => {
  ...
  return (
    <header className="h-16 border-b border-gray-100 bg-white flex items-center justify-between px-4 md:px-8 sticky top-0 z-10">
      {/* Breadcrumb & Responsive Hamburger Menu */}
      <div className="flex items-center gap-1.5">
        <button 
          onClick={onMenuClick}
          className="lg:hidden p-2 text-gray-400 hover:bg-gray-50 hover:text-gray-600 rounded-xl transition-all border-none bg-transparent cursor-pointer"
        >
